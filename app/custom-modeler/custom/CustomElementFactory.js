...
CustomElementFactory.prototype._getCustomElementSize = function(type) {
  var shapes = {
    ...
    'custom:resource-absence': { width: 50, height: 75 },
    'custom:resource-instance': { width: 50, height: 75 },
    'custom:role': { width: 50, height: 75 },
    'custom:role-absence': { width: 50, height: 75 },
    'custom:role-instance': { width: 50, height: 75 },
    'custom:group': { width: 60, height: 80 },
    'custom:group-absence': { width: 60, height: 80 },
    'custom:group-instance': { width: 60, height: 80 },
  };
